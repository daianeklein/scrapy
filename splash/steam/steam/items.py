...
class SteamItem(scrapy.Item):
    game_url = scrapy.Field(output_processor = TakeFirst()) #it needs to be output_processor
    ...
    discount_price = scrapy.Field(input_processor = MapCompose(clean_discounted_price),
                                  output_processor = TakeFirst())
